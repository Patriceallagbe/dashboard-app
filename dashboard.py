...
.msg { padding:14px; border-radius:12px; margin:10px 0; font-weight:700; }
...
while True:
    ...
    with zone.container():
        ...
        with col2:
            ...
            if temp_alarm:
                st.markdown("<div class='msg bad'>Température anormale</div>", unsafe_allow_html=True)
            ...
            if not any([presence_event, panic_event, temp_alarm, alarm_code_only]):
